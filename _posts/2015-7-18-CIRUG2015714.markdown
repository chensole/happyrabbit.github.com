...
Here is an example of reproducible report using R Markdown in RStudio including interactive figures/table from the packages mentioned. Run the following code and you can get this interactive webpage [http://linhui.org/Hui's_files/SampleForInteractiveReport.html](http://linhui.org/Hui's_files/SampleForInteractiveReport.html)
